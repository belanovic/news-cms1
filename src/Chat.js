...
export default function Chat() {
    ...
    const {roomsCall, setRoomsCall, showChat, setShowChat} = useContext(context);
    ...
    const handleReply = (i) => {
        ...
        setMessageToReplyDisplay(messages[messageToReplyIndex]);
...
/*     useEffect(() => {
    ...
    return (
        <>
        <div className={`chat-wrapper ${connectedChat? 'connected' : 'notConnected'}`} onClick={(e) => {e.stopPropagation()}}>
            <div 
                className = {`chat-icon ${showChat && "shownChat"}`}
                onClick = {() => setShowChat(prev => !prev)} 
            >
                <span>Chat</span>
            </div>
            <div
                className = {`chat bla ${showChat && "show"}`}
       ...
       {/*          <div className = "chat-rooms">
                        ...
                        return (
                            <div className ={`one-message ${msg.username === usernameLoggedIn? 'my-message' : 'their-message'}`} key = {i}>
                                {msg.username === usernameLoggedIn? 
                                    ...
                                    >
                                        {msg.profileImgURLSmall === 'generic'? 
                                        ...
                                        >
                                            <div className = "chat-profile-content">
                                                {msg.profileImgURLLarge === 'generic'? 
                                                    <i className="fas fa-user"></i> 
                                                    : 
                                ...
                                >       <div 
                                        ...
                                        <div className = "date-reply">
                                            ...
                                            <div className = "reply">
                                                <i 
                                                    className= {`fa-solid fa-reply ${displayMessageToReply && i === messageToReplyIndex? 'active' : ''}`}
                ...
                <div 
                    ...
                    >
                        <span className = 'usernameToReply' >Reply to {messageToReplyDisplay && messageToReplyDisplay.username}: </span> 
                        <span className='textToReply' >{shortenSentence(messageToReplyDisplay && messageToReplyDisplay.text, 25)}</span>
                    </div>
                    <div className = "chat-input" >
                        ...
                        <div className='send-btn'>
                            <img 
                            onClick={(e) => sendMessageClick(e)}
                                src = 'https://firebasestorage.googleapis.com/v0/b/site-news-storage.appspot.com/o/site-news-images%2Fthumbs%2Fposalji1.png?alt=media&token=fcb4d72e-454a-416b-846f-0f652c66cee5'
